...
public class App extends Application {//00016023 - main class who create the welcome window
    ...
    public void start(Stage stage) throws IOException {//00016023 - Function who initialize the program
        FXMLLoader fxmlLoader = new FXMLLoader(App.class.getResource("welcome-screen.fxml"));//00016023 - Define the fxml loader with the name of the file taht we want to use
        ...
        stage.resizableProperty().setValue(false);//00016023 - Define the resizable propierty as false
